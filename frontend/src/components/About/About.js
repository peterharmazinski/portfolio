  ...
  return (
    <div className='about' style={{padding: '200px 0 0 0'}}>
      ...
      <div className='about__contact'>
        ...
        {resume && (
          <Button startIcon={<PictureAsPdfIcon />} onClick={handleOpen} variant='outlined' type='button' className='link--icon'>
            Resume
          </Button>
        )}
        ...
        <Button variant='outlined' href={social.tableau} aria-label='tableau' className='link--icon'
        ...
        {social && (
          <>
            {social.github && (
              <Button startIcon={<GitHubIcon/>} variant='outlined' href={social.github} aria-label='github' className='link--icon'>
                Github
              </Button>
            )}
