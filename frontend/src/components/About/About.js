...
const About = ({modalOpen, toggleModal}) => {
  ...
  return (
    <div className='about' style={{padding: '200px 0 0 0'}}>
      <div className='div1'>
      {name && (
        <Typography variant='h1' className='center hero' style={{ whiteSpace: 'pre' }}>
          Hi, I'm&nbsp;
          <Typography className='about__name center' component='span' color='primary' style={{fontSize: 'inherit'}}>Peter&nbsp;</Typography>
          <Typography className='about__name center' component='span' color='primary' style={{fontSize: 'inherit'}}>Harmazinski</Typography>
        </Typography>
      )}
